<?php
  ...
  $teamStmt = $pdo->prepare('SELECT team_id,team_name FROM Teams JOIN Games JOIN Groups WHERE (Teams.team_id=Games.team_a OR Teams.team_id=Games.team_b) AND Games.tourn_id=Groups.fk_tourn_id AND Games.first_round=1 AND Groups.group_id=:gid');
