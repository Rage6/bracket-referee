<?php
  ...
  $teamStmt = $pdo->prepare('SELECT Games.game_id,Games.next_game,Games.team_a,Games.team_b,Games.get_wildcard FROM Games JOIN Groups WHERE Games.tourn_id=Groups.fk_tourn_id AND Groups.group_id=:gid');
